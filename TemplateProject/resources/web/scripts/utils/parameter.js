 ...
 */
export function normalizedToDisplay(paramIdx, normalizedValue) {
 ...
 */
export function normalizedToActual(paramIdx, normalizedValue) {
 ...
 */
function getParamDisplayConfig(paramIdx) {
    switch (paramIdx) {
        case EParams.kParamGain:
        case EParams.kParamSustain:
        case EParams.kParamLFODepth:
 ...
 */
export function getParamInputId(paramIdx) {
    const paramNames = {
 ...
 */
export function getParamValueId(paramIdx) {
