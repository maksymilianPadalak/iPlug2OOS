...
declare global {
  interface Window {
    ...
    TemplateProjectController?: WAMControllerConstructor;
    TemplateProject2Controller?: WAMControllerConstructor;
    TemplateProject_WAM?: WAMController;
    TemplateProject2_WAM?: WAMController;
  }
}
