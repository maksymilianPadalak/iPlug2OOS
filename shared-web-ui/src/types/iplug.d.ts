...
declare global {
  interface Window {
    ...
    initWebViewWAMAdapter?: (wamController: unknown) => void;
    setupWAMMessageHandlers?: (controller: unknown) => void;
    getIPlugEnvironment?: () => 'webview' | 'wam';
    Plugin_WAM?: {
      sendMessage: (msg: string, data: string, dataSize: number) => void;
    };
  }
}
